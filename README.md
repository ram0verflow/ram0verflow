...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1960"><img src="assets/ledger-light.svg?v=1960" width="100%" alt="ROFL ledger, height 1960"></picture>

| | |
|---|---|
| **height** | `1960` |
| **tip** | `75b2cae6dfb8b1ac53fe7ccb6935cf22ca6cca6777f25b2cea21003a6e30c25a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,793,262,630,810` expected hashes |
| **supply** | `20965.91796875 ROFL` in `1961` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `518` | `26.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `710.36156250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1960. Verify it yourself: <code>python3 verify.py</code></sub>
