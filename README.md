...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1699"><img src="assets/ledger-light.svg?v=1699" width="100%" alt="ROFL ledger, height 1699"></picture>

| | |
|---|---|
| **height** | `1699` |
| **tip** | `d417e3e06733723e6325be30f9c39aef53acabc18f32be49911fa60df90159b9` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,972,223,169,628` expected hashes |
| **supply** | `20921.87500000 ROFL` in `1699` unspent outputs |
...
| `1690` | `c824ed53404743b601ff…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-11 13:43 UTC |
...
| [@ywltby](https://github.com/ywltby) | `329` | `19.4%` |
| [@americanvain](https://github.com/americanvain) | `254` | `14.9%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `162.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1699. Verify it yourself: <code>python3 verify.py</code></sub>
