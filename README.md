...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1834"><img src="assets/ledger-light.svg?v=1834" width="100%" alt="ROFL ledger, height 1834"></picture>

| | |
|---|---|
| **height** | `1834` |
| **tip** | `d0255fa46f4545494dace76f31000945effbf4fcb201e264852c847403083c00` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,396,898,752,998` expected hashes |
| **supply** | `20948.24218750 ROFL` in `1835` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1834` | `d0255fa46f4545494dac…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.19531250` | 2026-09-12 01:05 UTC |
| `1833` | `53f12a4a987c0706cd17…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.19531250` | 2026-09-12 01:02 UTC |
| `1832` | `8207707824a46b7c202b…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-12 01:02 UTC |
| `1831` | `7016bbe6dbcd300f95ee…` | [@ywltby](https://github.com/ywltby) | `谁是大明星？` | `1` | `0.19531250` | 2026-09-12 00:51 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `26.6%` |
| [@ywltby](https://github.com/ywltby) | `414` | `22.6%` |
| [@americanvain](https://github.com/americanvain) | `301` | `16.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `696.49437500 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `171.68068750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1834. Verify it yourself: <code>python3 verify.py</code></sub>
