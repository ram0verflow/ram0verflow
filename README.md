...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1965"><img src="assets/ledger-light.svg?v=1965" width="100%" alt="ROFL ledger, height 1965"></picture>

| | |
|---|---|
| **height** | `1965` |
| **tip** | `eb3430fe2a20352f84dd6bee89171dae7d9c2857b8df099adc538c6aa46674ff` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,808,991,356,120` expected hashes |
| **supply** | `20966.40625000 ROFL` in `1966` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1965` | `eb3430fe2a20352f84dd…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.09765625` | 2026-09-12 13:54 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `522` | `26.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `710.75218750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1965. Verify it yourself: <code>python3 verify.py</code></sub>
