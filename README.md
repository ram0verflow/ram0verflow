...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1420"><img src="assets/ledger-light.svg?v=1420" width="100%" alt="ROFL ledger, height 1420"></picture>

| | |
|---|---|
| **height** | `1420` |
| **tip** | `7dabe882884c8de155b7e5948993c46a4adf7f842f0b38d641e49991f0de05da` |
| **difficulty** | `393,905,173,218,602,683,998,953,148,026,500,405,002,240.0`  (bits `0x0d0389d5`) |
| **chainwork** | `8,074,215,034,953,229,248,023,696,836,390,782,662,145,293,655,286` expected hashes |
| **supply** | `20797.65625000 ROFL` in `1420` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `34.3%` |
| [@ywltby](https://github.com/ywltby) | `217` | `15.3%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1420. Verify it yourself: <code>python3 verify.py</code></sub>
