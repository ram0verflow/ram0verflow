...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2005"><img src="assets/ledger-light.svg?v=2005" width="100%" alt="ROFL ledger, height 2005"></picture>

| | |
|---|---|
| **height** | `2005` |
| **tip** | `e8a2af3b6beb6e2da309d3823a6afd4b026440a89e218f3c687a650a4a6170a6` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,934,821,158,600` expected hashes |
| **supply** | `20970.31250000 ROFL` in `2006` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `553` | `27.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `713.77953125 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2005. Verify it yourself: <code>python3 verify.py</code></sub>
