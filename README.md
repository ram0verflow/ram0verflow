...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1855"><img src="assets/ledger-light.svg?v=1855" width="100%" alt="ROFL ledger, height 1855"></picture>

| | |
|---|---|
| **height** | `1855` |
| **tip** | `a06820681df365946abfb00582a68e410c5f102e51aa8847cea32a935c48e4d9` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,462,959,399,300` expected hashes |
| **supply** | `20952.34375000 ROFL` in `1856` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1855. Verify it yourself: <code>python3 verify.py</code></sub>
