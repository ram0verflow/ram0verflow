...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2035"><img src="assets/ledger-light.svg?v=2035" width="100%" alt="ROFL ledger, height 2035"></picture>

| | |
|---|---|
| **height** | `2035` |
| **tip** | `ee9bbd72ccccba5f27f888e9a91373b0ff240ddd93c882dd9d31752875525f42` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,029,193,510,460` expected hashes |
| **supply** | `20973.24218750 ROFL` in `2036` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `570` | `28.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `715.43968750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2035. Verify it yourself: <code>python3 verify.py</code></sub>
