...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1879"><img src="assets/ledger-light.svg?v=1879" width="100%" alt="ROFL ledger, height 1879"></picture>

| | |
|---|---|
| **height** | `1879` |
| **tip** | `595f80f162cc12e7060a034a1672114026ca064acf93e788fd640af66a0a5c3e` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,538,457,280,788` expected hashes |
| **supply** | `20957.03125000 ROFL` in `1880` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1879` | `595f80f162cc12e7060a…` | [@ywltby](https://github.com/ywltby) | `飞八分钱干飞马` | `1` | `0.19531250` | 2026-09-12 05:16 UTC |
...
| [@ywltby](https://github.com/ywltby) | `442` | `23.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `701.96312500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1879. Verify it yourself: <code>python3 verify.py</code></sub>
