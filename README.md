...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2067"><img src="assets/ledger-light.svg?v=2067" width="100%" alt="ROFL ledger, height 2067"></picture>

| | |
|---|---|
| **height** | `2067` |
| **tip** | `7a23b2f5849baa79e370f3ce80cb14e256a6525df87d258a73ffd12a1652af6b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,129,857,352,444` expected hashes |
| **supply** | `20976.36718750 ROFL` in `2068` unspent outputs |
...
| `2058` | `3e2bfbea2525da6aad00…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.09765625` | 2026-09-12 23:44 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `598` | `28.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `718.17406250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2067. Verify it yourself: <code>python3 verify.py</code></sub>
