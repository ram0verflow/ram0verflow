...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1921"><img src="assets/ledger-light.svg?v=1921" width="100%" alt="ROFL ledger, height 1921"></picture>

| | |
|---|---|
| **height** | `1921` |
| **tip** | `b37c9d6cb2a639967ef77a0fde81db95a1533d954869027fef8ef203d5818b77` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,670,578,573,392` expected hashes |
| **supply** | `20962.10937500 ROFL` in `1922` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `482` | `25.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `706.84593750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1921. Verify it yourself: <code>python3 verify.py</code></sub>
