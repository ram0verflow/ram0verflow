...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1706"><img src="assets/ledger-light.svg?v=1706" width="100%" alt="ROFL ledger, height 1706"></picture>

| | |
|---|---|
| **height** | `1706` |
| **tip** | `f68711bc57d02dfc409158426b65687a2fab9ead656ed8be8afca905fbdb05c4` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,994,243,385,062` expected hashes |
| **supply** | `20923.24218750 ROFL` in `1706` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1706` | `f68711bc57d02dfc4091…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.19531250` | 2026-09-11 14:47 UTC |
...
| [@ywltby](https://github.com/ywltby) | `333` | `19.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `680.66406250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1706. Verify it yourself: <code>python3 verify.py</code></sub>
