...
|---|---|
| **height** | `1578` |
| **tip** | `353dda4b1dd0702bcd5eef080b99e7230cb2ed2340b76b573a987d4894a6f462` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,591,588,017,126` expected hashes |
...
| [@americanvain](https://github.com/americanvain) | `203` | `12.9%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `144.53125000 ROFL` |
