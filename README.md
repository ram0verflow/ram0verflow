...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1815"><img src="assets/ledger-light.svg?v=1815" width="100%" alt="ROFL ledger, height 1815"></picture>

| | |
|---|---|
| **height** | `1815` |
| **tip** | `82c34ef388b9aa03673456947c381e215294748a6cdbac06a2867f48acb252a7` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,337,129,596,820` expected hashes |
| **supply** | `20944.53125000 ROFL` in `1816` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `401` | `22.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `693.95531250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1815. Verify it yourself: <code>python3 verify.py</code></sub>
