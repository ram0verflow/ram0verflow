...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1929"><img src="assets/ledger-light.svg?v=1929" width="100%" alt="ROFL ledger, height 1929"></picture>

| | |
|---|---|
| **height** | `1929` |
| **tip** | `1358e78f98a1d49044a688674c798fe66919ae099ad4c199c10d89c1dd6b25f9` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,695,744,533,888` expected hashes |
| **supply** | `20962.89062500 ROFL` in `1930` unspent outputs |
...
| `1920` | `bc5a1384b3b95cc9e495…` | [@iamgd67](https://github.com/iamgd67) | `gm` | `1` | `0.09765625` | 2026-09-12 09:24 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `490` | `25.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `707.62718750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1929. Verify it yourself: <code>python3 verify.py</code></sub>
