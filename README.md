...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1686"><img src="assets/ledger-light.svg?v=1686" width="100%" alt="ROFL ledger, height 1686"></picture>

| | |
|---|---|
| **height** | `1686` |
| **tip** | `7310ce75018f9663e998a879dbe5aee46f72e47d023409b60e6e2be8cdb2e9c5` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,931,328,483,822` expected hashes |
| **supply** | `20919.33593750 ROFL` in `1686` unspent outputs |
...
| `1684` | `d2c9f3fafb08f9905e0d…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.19531250` | 2026-09-11 13:15 UTC |
| `1683` | `d1f902d2423ed2310619…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-11 13:15 UTC |
| `1682` | `45c36744acb861b83d38…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.19531250` | 2026-09-11 13:05 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `28.9%` |
| [@ywltby](https://github.com/ywltby) | `322` | `19.1%` |
| [@americanvain](https://github.com/americanvain) | `249` | `14.8%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `678.51562500 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `161.52343750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1686. Verify it yourself: <code>python3 verify.py</code></sub>
