...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2104"><img src="assets/ledger-light.svg?v=2104" width="100%" alt="ROFL ledger, height 2104"></picture>

| | |
|---|---|
| **height** | `2104` |
| **tip** | `28a84a63a63372c15fff97d2d5ade76d8ada6762a48b3b7dfaceabcc05c46c39` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,246,249,919,738` expected hashes |
| **supply** | `20979.73632810 ROFL` in `2105` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `633` | `30.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `721.34789060 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2104. Verify it yourself: <code>python3 verify.py</code></sub>
