...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1680"><img src="assets/ledger-light.svg?v=1680" width="100%" alt="ROFL ledger, height 1680"></picture>

| | |
|---|---|
| **height** | `1680` |
| **tip** | `f5ca308e8a45ad80585852be4fef8863c11c4ac4fbf9481afb5fb614e8d12908` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,912,454,013,450` expected hashes |
| **supply** | `20918.16406250 ROFL` in `1680` unspent outputs |
...
| `1671` | `f3f9d631e4c9b5cbf284…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.39062500` | 2026-09-11 12:21 UTC |
...
| [@americanvain](https://github.com/americanvain) | `245` | `14.6%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `160.74218750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1680. Verify it yourself: <code>python3 verify.py</code></sub>
