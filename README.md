...
|---|---|
| **height** | `1573` |
| **tip** | `0236e2a11fe0a822329821ccd56ad6dc0a79e8f034ab18329f049372b5042452` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,575,859,291,816` expected hashes |
...
| [@americanvain](https://github.com/americanvain) | `200` | `12.7%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `143.35937500 ROFL` |
