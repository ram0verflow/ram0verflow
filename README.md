...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1439"><img src="assets/ledger-light.svg?v=1439" width="100%" alt="ROFL ledger, height 1439"></picture>

| | |
|---|---|
| **height** | `1439` |
| **tip** | `faabf0a88a79d322867b29793a6614efe6b26a3fe20a73bc924b31502745bb42` |
| **difficulty** | `1,425,376,885,543,683,781,568,524,632,380,112,076,013,568.0`  (bits `0x0d00fa54`) |
| **chainwork** | `33,227,189,457,865,498,316,959,211,527,965,388,127,553,674,800,576` expected hashes |
| **supply** | `20812.50000000 ROFL` in `1439` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1439` | `faabf0a88a79d322867b…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 22:52 UTC |
...
| [@americanvain](https://github.com/americanvain) | `124` | `8.6%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `107.81250000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1439. Verify it yourself: <code>python3 verify.py</code></sub>
