...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1722"><img src="assets/ledger-light.svg?v=1722" width="100%" alt="ROFL ledger, height 1722"></picture>

| | |
|---|---|
| **height** | `1722` |
| **tip** | `9ea93b817b7f75529e16267bb59273d99438e2e5d3e7f3df27eb6e770a953632` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,044,575,306,054` expected hashes |
| **supply** | `20926.36718750 ROFL` in `1722` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1722` | `9ea93b817b7f75529e16…` | [@ywltby](https://github.com/ywltby) | `菲比啾比` | `1` | `0.19531250` | 2026-09-11 16:04 UTC |
...
| [@ywltby](https://github.com/ywltby) | `343` | `19.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `682.61718750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1722. Verify it yourself: <code>python3 verify.py</code></sub>
