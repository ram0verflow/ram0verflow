...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1906"><img src="assets/ledger-light.svg?v=1906" width="100%" alt="ROFL ledger, height 1906"></picture>

| | |
|---|---|
| **height** | `1906` |
| **tip** | `a42b398e2e014a20ee6dcdcadcf88163973ae95cabd4975f0aa539330535b78a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,623,392,397,462` expected hashes |
| **supply** | `20960.64453125 ROFL` in `1907` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1906` | `a42b398e2e014a20ee6d…` | [@ywltby](https://github.com/ywltby) | `飞八分钱干飞马` | `1` | `0.09765625` | 2026-09-12 08:01 UTC |
...
| [@ywltby](https://github.com/ywltby) | `468` | `24.5%` |
| [@americanvain](https://github.com/americanvain) | `315` | `16.5%` |
| [@sd5884703](https://github.com/sd5884703) | `142` | `7.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `705.47875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1906. Verify it yourself: <code>python3 verify.py</code></sub>
