...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1999"><img src="assets/ledger-light.svg?v=1999" width="100%" alt="ROFL ledger, height 1999"></picture>

| | |
|---|---|
| **height** | `1999` |
| **tip** | `503b32d829e4b90cd7e4c872df15eec3732ad0d6f3b303fad95e3ae0d06d8289` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,915,946,688,228` expected hashes |
| **supply** | `20969.72656250 ROFL` in `2000` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1999` | `503b32d829e4b90cd7e4…` | [@ywltby](https://github.com/ywltby) | `现在拿了世界冠军还在骂我，那拿了世界冠军有什么用呢？` | `1` | `0.09765625` | 2026-09-12 17:26 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `548` | `27.4%` |
...
| [@lusgt](https://github.com/lusgt) | `17` | `0.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `713.29125000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1999. Verify it yourself: <code>python3 verify.py</code></sub>
