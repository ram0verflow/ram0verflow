...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1949"><img src="assets/ledger-light.svg?v=1949" width="100%" alt="ROFL ledger, height 1949"></picture>

| | |
|---|---|
| **height** | `1949` |
| **tip** | `0932bafee6648a4dcc75d9689164e47ff85655eda5639503c7cecefbf5873c17` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,758,659,435,128` expected hashes |
| **supply** | `20964.84375000 ROFL` in `1950` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `508` | `26.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `709.38500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1949. Verify it yourself: <code>python3 verify.py</code></sub>
