...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2105"><img src="assets/ledger-light.svg?v=2105" width="100%" alt="ROFL ledger, height 2105"></picture>

| | |
|---|---|
| **height** | `2105` |
| **tip** | `1482d6a314410254a355fdb6cacf29c78c2e100f3c203f0e266569dc57876daf` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,249,395,664,800` expected hashes |
| **supply** | `20979.78515622 ROFL` in `2106` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2105` | `1482d6a314410254a355…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.04882812` | 2026-09-13 05:33 UTC |
| `2104` | `28a84a63a63372c15fff…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.04882812` | 2026-09-13 05:29 UTC |
| `2103` | `69d76950f0bb0cc67789…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.04882812` | 2026-09-13 05:21 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `634` | `30.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `721.39671872 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2105. Verify it yourself: <code>python3 verify.py</code></sub>
