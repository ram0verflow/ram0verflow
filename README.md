...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2102"><img src="assets/ledger-light.svg?v=2102" width="100%" alt="ROFL ledger, height 2102"></picture>

| | |
|---|---|
| **height** | `2102` |
| **tip** | `1928c428b4cba0325b6f87b73e2411fa4dbcef7a43bbeb982950232768e85d4b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,239,958,429,614` expected hashes |
| **supply** | `20979.63867186 ROFL` in `2103` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2102` | `1928c428b4cba0325b6f…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.04882812` | 2026-09-13 05:16 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `631` | `30.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `721.25023436 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2102. Verify it yourself: <code>python3 verify.py</code></sub>
