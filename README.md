...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2065"><img src="assets/ledger-light.svg?v=2065" width="100%" alt="ROFL ledger, height 2065"></picture>

| | |
|---|---|
| **height** | `2065` |
| **tip** | `d84f8918d0c352e1cfdc7f0d46a53ce95f768761e808d73fe429045f27e309b9` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,123,565,862,320` expected hashes |
| **supply** | `20976.17187500 ROFL` in `2066` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `596` | `28.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `717.97875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2065. Verify it yourself: <code>python3 verify.py</code></sub>
