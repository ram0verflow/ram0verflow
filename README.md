...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1678"><img src="assets/ledger-light.svg?v=1678" width="100%" alt="ROFL ledger, height 1678"></picture>

| | |
|---|---|
| **height** | `1678` |
| **tip** | `0f34a9c5aa4ebca7836997ec892cad0bb8b73e339cb2e123ebaeac332547988d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,906,162,523,326` expected hashes |
| **supply** | `20917.57812500 ROFL` in `1678` unspent outputs |
...
| `1669` | `83bc8caa88ee72b30ebd…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.39062500` | 2026-09-11 12:17 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `29.1%` |
| [@ywltby](https://github.com/ywltby) | `320` | `19.1%` |
| [@americanvain](https://github.com/americanvain) | `243` | `14.5%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `160.15625000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1678. Verify it yourself: <code>python3 verify.py</code></sub>
