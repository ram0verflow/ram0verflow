...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1935"><img src="assets/ledger-light.svg?v=1935" width="100%" alt="ROFL ledger, height 1935"></picture>

| | |
|---|---|
| **height** | `1935` |
| **tip** | `21f2c78eef09fffc3aa872359a00b5b44dddbd2330762226cd9d25578ba54ac3` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,714,619,004,260` expected hashes |
| **supply** | `20963.47656250 ROFL` in `1936` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `494` | `25.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `708.01781250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1935. Verify it yourself: <code>python3 verify.py</code></sub>
