...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2077"><img src="assets/ledger-light.svg?v=2077" width="100%" alt="ROFL ledger, height 2077"></picture>

| | |
|---|---|
| **height** | `2077` |
| **tip** | `5b30b7ea9b4db899bc9c240456dd071f2e26b68284151d42a5c921754bfa431e` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,161,314,803,064` expected hashes |
| **supply** | `20977.34375000 ROFL` in `2078` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `608` | `29.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `719.15062500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2077. Verify it yourself: <code>python3 verify.py</code></sub>
