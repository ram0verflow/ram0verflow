...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1941"><img src="assets/ledger-light.svg?v=1941" width="100%" alt="ROFL ledger, height 1941"></picture>

| | |
|---|---|
| **height** | `1941` |
| **tip** | `800d9bfe0d96825d7b364632123bf95c173b5492c5bc7b58f1dfda78b9d64901` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,733,493,474,632` expected hashes |
| **supply** | `20964.06250000 ROFL` in `1942` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `500` | `25.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `708.60375000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1941. Verify it yourself: <code>python3 verify.py</code></sub>
