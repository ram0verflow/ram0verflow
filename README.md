...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1940"><img src="assets/ledger-light.svg?v=1940" width="100%" alt="ROFL ledger, height 1940"></picture>

| | |
|---|---|
| **height** | `1940` |
| **tip** | `631a813a57ce0eaf8a3650f91f41a534573525f0d9b28b4892d51876d3b12d74` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,730,347,729,570` expected hashes |
| **supply** | `20963.96484375 ROFL` in `1941` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `499` | `25.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `708.50609375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1940. Verify it yourself: <code>python3 verify.py</code></sub>
