...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1992"><img src="assets/ledger-light.svg?v=1992" width="100%" alt="ROFL ledger, height 1992"></picture>

| | |
|---|---|
| **height** | `1992` |
| **tip** | `b1839293899fbf0f91f2f51dd0e88288ab6cc811173e6cafa7009263f60def1b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,893,926,472,794` expected hashes |
| **supply** | `20969.04296875 ROFL` in `1993` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `542` | `27.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `712.70531250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1992. Verify it yourself: <code>python3 verify.py</code></sub>
