...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1336"><img src="assets/ledger-light.svg?v=1336" width="100%" alt="ROFL ledger, height 1336"></picture>

| | |
|---|---|
| **height** | `1336` |
| **tip** | `8583e862fa76ca50f10ab40ffeb3592df76777bec104ae6bf002d5975a25c4c6` |
| **difficulty** | `866,483,702,191,367,860,376,226,636,790,732,161,024.0`  (bits `0x0e064891`) |
| **chainwork** | `15,504,008,009,547,441,422,896,731,069,071,753,312,527,456,687` expected hashes |
| **supply** | `20732.03125000 ROFL` in `1336` unspent outputs |
...
| `1332` | `91940edc7b49a4b0bc72…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.78125000` | 2026-09-10 17:18 UTC |
| `1331` | `762ff50f2ffaa0b69c28…` | [@ywltby](https://github.com/ywltby) | `let’s Go~~` | `1` | `0.78125000` | 2026-09-10 17:18 UTC |
| `1330` | `c61291dc29671ec060cb…` | [@ethahae](https://github.com/ethahae) | `gm from a C solver` | `1` | `0.78125000` | 2026-09-10 17:13 UTC |
| `1329` | `343ed1af82e92994a9ba…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.78125000` | 2026-09-10 17:06 UTC |
| `1328` | `f3483c6d2d53ebe1b9be…` | [@ywltby](https://github.com/ywltby) | `都是同龄人，我原本没想降维打击。` | `1` | `0.78125000` | 2026-09-10 17:03 UTC |
| `1327` | `347728344da4d859f745…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 17:00 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `36.5%` |
| [@ywltby](https://github.com/ywltby) | `193` | `14.4%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `613.28125000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1336. Verify it yourself: <code>python3 verify.py</code></sub>
