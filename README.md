...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1800"><img src="assets/ledger-light.svg?v=1800" width="100%" alt="ROFL ledger, height 1800"></picture>

| | |
|---|---|
| **height** | `1800` |
| **tip** | `e7e38101a963bdd3f2f254d89f6de774e546db759638f7775a3db63fa0650e7b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,289,943,420,890` expected hashes |
| **supply** | `20941.60156250 ROFL` in `1801` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `290` | `16.1%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `169.53225000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1800. Verify it yourself: <code>python3 verify.py</code></sub>
