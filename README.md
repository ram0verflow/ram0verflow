...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1862"><img src="assets/ledger-light.svg?v=1862" width="100%" alt="ROFL ledger, height 1862"></picture>

| | |
|---|---|
| **height** | `1862` |
| **tip** | `3ceb0490f6ca9bb3db10136494572bb4a4bfb1648dae43427e5c8d2e6a3b4430` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,484,979,614,734` expected hashes |
| **supply** | `20953.71093750 ROFL` in `1863` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1862` | `3ceb0490f6ca9bb3db10…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.19531250` | 2026-09-12 03:41 UTC |
...
| [@ywltby](https://github.com/ywltby) | `427` | `22.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `699.03343750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1862. Verify it yourself: <code>python3 verify.py</code></sub>
