...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1947"><img src="assets/ledger-light.svg?v=1947" width="100%" alt="ROFL ledger, height 1947"></picture>

| | |
|---|---|
| **height** | `1947` |
| **tip** | `2bd451a8fbc3453bef2fd178364273dfd4b248af9c2e7b763c214ff42fa844ba` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,752,367,945,004` expected hashes |
| **supply** | `20964.64843750 ROFL` in `1948` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `506` | `26.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `709.18968750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1947. Verify it yourself: <code>python3 verify.py</code></sub>
