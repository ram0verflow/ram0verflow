...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1372"><img src="assets/ledger-light.svg?v=1372" width="100%" alt="ROFL ledger, height 1372"></picture>

| | |
|---|---|
| **height** | `1372` |
| **tip** | `2c78887fa29057e7928b74f59dabeb6eaf8757ccb89e856d8f1583d8db69add9` |
| **difficulty** | `9,083,344,106,117,049,959,262,311,242,559,085,608,960.0`  (bits `0x0e009972`) |
| **chainwork** | `189,749,763,287,180,669,135,916,868,992,486,870,646,622,731,692` expected hashes |
| **supply** | `20760.15625000 ROFL` in `1372` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1372` | `2c78887fa29057e7928b…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:27 UTC |
| `1371` | `1d177139a1afc229e358…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:24 UTC |
| `1370` | `2e7e9a0b94992c8077ea…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:21 UTC |
| `1369` | `6d80683f4cde72fde9f5…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:18 UTC |
| `1368` | `d4d0023c897766fba1d6…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:15 UTC |
| `1367` | `ffd3cdcb79ae8e4cc616…` | [@ywltby](https://github.com/ywltby) | `菲八啾比` | `1` | `0.78125000` | 2026-09-10 19:09 UTC |
| `1366` | `cf56a684b32bfe2ca0bc…` | [@ywltby](https://github.com/ywltby) | `飞八分钱` | `1` | `0.78125000` | 2026-09-10 19:09 UTC |
| `1365` | `f170d2fd4d42c9c06de6…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:06 UTC |
| `1364` | `01887e5120bc9240fc0d…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:03 UTC |
| `1363` | `4d119844f1aa40feed4e…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:00 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `35.5%` |
| [@ywltby](https://github.com/ywltby) | `205` | `14.9%` |
| [@sd5884703](https://github.com/sd5884703) | `137` | `10.0%` |
| [@uselessfree](https://github.com/uselessfree) | `110` | `8.0%` |
| [@bulanzade](https://github.com/bulanzade) | `96` | `7.0%` |
| [@americanvain](https://github.com/americanvain) | `71` | `5.2%` |
| [@ram0verflow](https://github.com/ram0verflow) | `62` | `4.5%` |
| [@ethahae](https://github.com/ethahae) | `52` | `3.8%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `622.65625000 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `66.40625000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1372. Verify it yourself: <code>python3 verify.py</code></sub>
