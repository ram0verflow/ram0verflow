...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1843"><img src="assets/ledger-light.svg?v=1843" width="100%" alt="ROFL ledger, height 1843"></picture>

| | |
|---|---|
| **height** | `1843` |
| **tip** | `0c299911fc3af6294e901f32e238bcf66ed99f7637b2bd1fbef49492fa4ba6ef` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,425,210,458,556` expected hashes |
| **supply** | `20950.00000000 ROFL` in `1844` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `305` | `16.5%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `172.46193750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1843. Verify it yourself: <code>python3 verify.py</code></sub>
