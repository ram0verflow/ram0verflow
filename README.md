...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1326"><img src="assets/ledger-light.svg?v=1326" width="100%" alt="ROFL ledger, height 1326"></picture>

| | |
|---|---|
| **height** | `1326` |
| **tip** | `0cc247d4861066099cdeb064479fc0d06cf4520f043543de39ba625c9bd369b2` |
| **difficulty** | `304,713,267,544,757,510,766,286,278,720,648,904,704.0`  (bits `0x0e11de20`) |
| **chainwork** | `7,007,326,859,737,287,490,342,917,160,581,749,567,027,338,817` expected hashes |
| **supply** | `20724.21875000 ROFL` in `1326` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `47` | `3.5%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `47.65625000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1326. Verify it yourself: <code>python3 verify.py</code></sub>
