...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1837"><img src="assets/ledger-light.svg?v=1837" width="100%" alt="ROFL ledger, height 1837"></picture>

| | |
|---|---|
| **height** | `1837` |
| **tip** | `a968f035b758f091e1873260a225862e067e0c1c6e9ae7cba9099d3a527cd7cd` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,406,335,988,184` expected hashes |
| **supply** | `20948.82812500 ROFL` in `1838` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `302` | `16.4%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `171.87600000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1837. Verify it yourself: <code>python3 verify.py</code></sub>
