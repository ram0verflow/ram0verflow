...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1373"><img src="assets/ledger-light.svg?v=1373" width="100%" alt="ROFL ledger, height 1373"></picture>

| | |
|---|---|
| **height** | `1373` |
| **tip** | `648018b9e4b0c64b11f7c3e0dafc26c6933e6077b77cc737fb513ce9ebbce006` |
| **difficulty** | `9,083,344,106,117,049,959,262,311,242,559,085,608,960.0`  (bits `0x0e009972`) |
| **chainwork** | `199,274,339,916,596,461,281,432,456,721,608,037,528,782,555,880` expected hashes |
| **supply** | `20760.93750000 ROFL` in `1373` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `72` | `5.2%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `67.18750000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1373. Verify it yourself: <code>python3 verify.py</code></sub>
