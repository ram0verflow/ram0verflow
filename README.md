...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1912"><img src="assets/ledger-light.svg?v=1912" width="100%" alt="ROFL ledger, height 1912"></picture>

| | |
|---|---|
| **height** | `1912` |
| **tip** | `0d4d5bc5ac120c4103961b7d37a7d90703e148bec75c2d9a8117de5f0993b711` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,642,266,867,834` expected hashes |
| **supply** | `20961.23046875 ROFL` in `1913` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `474` | `24.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `706.06468750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1912. Verify it yourself: <code>python3 verify.py</code></sub>
