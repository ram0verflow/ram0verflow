...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1640"><img src="assets/ledger-light.svg?v=1640" width="100%" alt="ROFL ledger, height 1640"></picture>

| | |
|---|---|
| **height** | `1640` |
| **tip** | `793d6a55a68483874cae09da3848ca6b9ded82b4843f74bc7a767c6cbc9bf223` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,786,624,210,970` expected hashes |
| **supply** | `20902.73437500 ROFL` in `1640` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `296` | `18.0%` |
| [@americanvain](https://github.com/americanvain) | `229` | `14.0%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `668.75000000 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `154.68750000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1640. Verify it yourself: <code>python3 verify.py</code></sub>
