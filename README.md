...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1763"><img src="assets/ledger-light.svg?v=1763" width="100%" alt="ROFL ledger, height 1763"></picture>

| | |
|---|---|
| **height** | `1763` |
| **tip** | `aa2fc77dee8b4f9280a18daa9a6feb04141569549d66c14c6df103e0707bf111` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,173,550,853,596` expected hashes |
| **supply** | `20934.37500000 ROFL` in `1764` unspent outputs |
...
| `1754` | `bbb16b7c09d606e631b3…` | [@ywltby](https://github.com/ywltby) | `菲八啾比` | `1` | `0.19531250` | 2026-09-11 18:28 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `27.7%` |
| [@ywltby](https://github.com/ywltby) | `369` | `20.9%` |
| [@americanvain](https://github.com/americanvain) | `275` | `15.6%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `166.60256250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1763. Verify it yourself: <code>python3 verify.py</code></sub>
