...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1684"><img src="assets/ledger-light.svg?v=1684" width="100%" alt="ROFL ledger, height 1684"></picture>

| | |
|---|---|
| **height** | `1684` |
| **tip** | `d2c9f3fafb08f9905e0dedbd8c7be14e03cd7fc6bc92cc975306c8cddde58275` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,925,036,993,698` expected hashes |
| **supply** | `20918.94531250 ROFL` in `1684` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1684. Verify it yourself: <code>python3 verify.py</code></sub>
