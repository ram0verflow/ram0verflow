...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1939"><img src="assets/ledger-light.svg?v=1939" width="100%" alt="ROFL ledger, height 1939"></picture>

| | |
|---|---|
| **height** | `1939` |
| **tip** | `b50dfee99293491e3eb2a0b72914b326f573c2c0cae90a0189b546caf5b5c2b5` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,727,201,984,508` expected hashes |
| **supply** | `20963.86718750 ROFL` in `1940` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `498` | `25.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `708.40843750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1939. Verify it yourself: <code>python3 verify.py</code></sub>
