...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1825"><img src="assets/ledger-light.svg?v=1825" width="100%" alt="ROFL ledger, height 1825"></picture>

| | |
|---|---|
| **height** | `1825` |
| **tip** | `88e6793d56c59f8acf815ccbf85019b883f789bcb4d30d73544b03dcd70d5ab0` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,368,587,047,440` expected hashes |
| **supply** | `20946.48437500 ROFL` in `1826` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `298` | `16.3%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `171.09475000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1825. Verify it yourself: <code>python3 verify.py</code></sub>
