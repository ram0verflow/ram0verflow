...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1790"><img src="assets/ledger-light.svg?v=1790" width="100%" alt="ROFL ledger, height 1790"></picture>

| | |
|---|---|
| **height** | `1790` |
| **tip** | `83fc34d8c4cfa6c509d73c09013509c4c08ca0ad8e1e955ea0776120a1868634` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,258,485,970,270` expected hashes |
| **supply** | `20939.64843750 ROFL` in `1791` unspent outputs |
...
| `1783` | `4684e38241837afbab87…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.19531250` | 2026-09-11 20:54 UTC |
| `1782` | `75f4be2daa74de248ec1…` | [@ywltby](https://github.com/ywltby) | `飞八分钱干飞马` | `1` | `0.19531250` | 2026-09-11 20:50 UTC |
| `1781` | `2a3c9519f53df172fceb…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-11 20:50 UTC |
...
| [@ywltby](https://github.com/ywltby) | `385` | `21.5%` |
| [@americanvain](https://github.com/americanvain) | `286` | `16.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `690.83031250 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `168.75100000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1790. Verify it yourself: <code>python3 verify.py</code></sub>
