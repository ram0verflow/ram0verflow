...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1857"><img src="assets/ledger-light.svg?v=1857" width="100%" alt="ROFL ledger, height 1857"></picture>

| | |
|---|---|
| **height** | `1857` |
| **tip** | `33856287be3a7a9b3577889aae54d8800e49509c23c39efcf6ab810dc4e04346` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,469,250,889,424` expected hashes |
| **supply** | `20952.73437500 ROFL` in `1858` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `313` | `16.8%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `174.02443750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1857. Verify it yourself: <code>python3 verify.py</code></sub>
