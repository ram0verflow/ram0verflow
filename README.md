...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1958"><img src="assets/ledger-light.svg?v=1958" width="100%" alt="ROFL ledger, height 1958"></picture>

| | |
|---|---|
| **height** | `1958` |
| **tip** | `87d414289b5044d345794ae472f4f63e7a209ecdac43bb8238a930d0d7a2a026` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,786,971,140,686` expected hashes |
| **supply** | `20965.72265625 ROFL` in `1959` unspent outputs |
...
| `1949` | `0932bafee6648a4dcc75…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.09765625` | 2026-09-12 12:22 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `516` | `26.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `710.16625000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1958. Verify it yourself: <code>python3 verify.py</code></sub>
