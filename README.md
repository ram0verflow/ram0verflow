...
|---|---|
| **height** | `1603` |
| **tip** | `6ce0d098392dfc2f36929cde14f32f24a136d05c320e83af054cdebb2063c682` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,670,231,643,676` expected hashes |
...
| `1594` | `30d8b3ea5faae7710247…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.39062500` | 2026-09-11 07:28 UTC |
...
| [@americanvain](https://github.com/americanvain) | `219` | `13.7%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `150.78125000 ROFL` |
