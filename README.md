...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2004"><img src="assets/ledger-light.svg?v=2004" width="100%" alt="ROFL ledger, height 2004"></picture>

| | |
|---|---|
| **height** | `2004` |
| **tip** | `d729b020f25391a4344d06fe2b08eb48fb79f38ce5f2df3aed16b29ddfa861ba` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,931,675,413,538` expected hashes |
| **supply** | `20970.21484375 ROFL` in `2005` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `552` | `27.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `713.68187500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2004. Verify it yourself: <code>python3 verify.py</code></sub>
