...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1948"><img src="assets/ledger-light.svg?v=1948" width="100%" alt="ROFL ledger, height 1948"></picture>

| | |
|---|---|
| **height** | `1948` |
| **tip** | `377c10bde487b501fa4eab75a8615fe7c6f7b4b17c0a24bcfe77bbff9abe8ec7` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,755,513,690,066` expected hashes |
| **supply** | `20964.74609375 ROFL` in `1949` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `507` | `26.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `709.28734375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1948. Verify it yourself: <code>python3 verify.py</code></sub>
