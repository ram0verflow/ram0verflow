...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1820"><img src="assets/ledger-light.svg?v=1820" width="100%" alt="ROFL ledger, height 1820"></picture>

| | |
|---|---|
| **height** | `1820` |
| **tip** | `98df64ca9b1038c7b40f58412ce8921fdd4a7f5b26646bfbd1e3546674232ffe` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,352,858,322,130` expected hashes |
| **supply** | `20945.50781250 ROFL` in `1821` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `405` | `22.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `694.73656250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1820. Verify it yourself: <code>python3 verify.py</code></sub>
