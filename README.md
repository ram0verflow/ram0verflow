...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1471"><img src="assets/ledger-light.svg?v=1471" width="100%" alt="ROFL ledger, height 1471"></picture>

| | |
|---|---|
| **height** | `1471` |
| **tip** | `9224f179b6b271ecb233a3b64ee1c06ca547d3375314122e997607daf786d15a` |
| **difficulty** | `16,869,108,873,798,119,444,282,596,843,616,542,039,998,464.0`  (bits `0x0c1526dc`) |
| **chainwork** | `397,051,002,738,493,395,141,013,791,413,720,428,827,063,566,349,392` expected hashes |
| **supply** | `20836.71875000 ROFL` in `1471` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1471` | `9224f179b6b271ecb233…` | [@ywltby](https://github.com/ywltby) | `飞八分钱` | `1` | `0.39062500` | 2026-09-11 00:27 UTC |
...
| [@ywltby](https://github.com/ywltby) | `234` | `15.9%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `644.53125000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1471. Verify it yourself: <code>python3 verify.py</code></sub>
