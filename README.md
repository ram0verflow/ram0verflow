...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1864"><img src="assets/ledger-light.svg?v=1864" width="100%" alt="ROFL ledger, height 1864"></picture>

| | |
|---|---|
| **height** | `1864` |
| **tip** | `ef4561a4b673a41de7264b5a4f815ba020893bbd4df424d7dcdd20b0bb0d14c1` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,491,271,104,858` expected hashes |
| **supply** | `20954.10156250 ROFL` in `1865` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `429` | `23.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `699.42406250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1864. Verify it yourself: <code>python3 verify.py</code></sub>
