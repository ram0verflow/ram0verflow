...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1946"><img src="assets/ledger-light.svg?v=1946" width="100%" alt="ROFL ledger, height 1946"></picture>

| | |
|---|---|
| **height** | `1946` |
| **tip** | `1a9e249d2ed91e602f01ead594fbbfac3ec9665964c0e0a16b6bd429af838c9a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,749,222,199,942` expected hashes |
| **supply** | `20964.55078125 ROFL` in `1947` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `505` | `25.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `709.09203125 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1946. Verify it yourself: <code>python3 verify.py</code></sub>
