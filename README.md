...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1392"><img src="assets/ledger-light.svg?v=1392" width="100%" alt="ROFL ledger, height 1392"></picture>

| | |
|---|---|
| **height** | `1392` |
| **tip** | `6b30855fb2565907343a1ae8c4a321b029d8c467c939cc670b21e276df80b98f` |
| **difficulty** | `114,929,876,523,135,904,463,331,461,869,381,187,796,992.0`  (bits `0x0d0c209b`) |
| **chainwork** | `897,010,740,009,069,033,747,349,914,928,787,965,209,536,821,064` expected hashes |
| **supply** | `20775.78125000 ROFL` in `1392` unspent outputs |
...
| `1383` | `9d2b3019484130b3e950…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 19:59 UTC |
...
| [@americanvain](https://github.com/americanvain) | `86` | `6.2%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `78.12500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1392. Verify it yourself: <code>python3 verify.py</code></sub>
