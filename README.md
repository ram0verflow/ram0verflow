...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1923"><img src="assets/ledger-light.svg?v=1923" width="100%" alt="ROFL ledger, height 1923"></picture>

| | |
|---|---|
| **height** | `1923` |
| **tip** | `dd37990fc31b38de584b92fe7de482a45aad70186a5df41e97edd8fa547ebe68` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,676,870,063,516` expected hashes |
| **supply** | `20962.30468750 ROFL` in `1924` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `484` | `25.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `707.04125000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1923. Verify it yourself: <code>python3 verify.py</code></sub>
