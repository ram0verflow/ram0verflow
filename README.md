...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2103"><img src="assets/ledger-light.svg?v=2103" width="100%" alt="ROFL ledger, height 2103"></picture>

| | |
|---|---|
| **height** | `2103` |
| **tip** | `69d76950f0bb0cc677890b0b3d6e8d7db490d1b81956525bc17ff65bfd365ef0` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,243,104,174,676` expected hashes |
| **supply** | `20979.68749998 ROFL` in `2104` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `632` | `30.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `721.29906248 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2103. Verify it yourself: <code>python3 verify.py</code></sub>
