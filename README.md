...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1332"><img src="assets/ledger-light.svg?v=1332" width="100%" alt="ROFL ledger, height 1332"></picture>

| | |
|---|---|
| **height** | `1332` |
| **tip** | `91940edc7b49a4b0bc726ddb3a289f965bbe45ec6a5a794393309ede56999b38` |
| **difficulty** | `866,483,702,191,367,860,376,226,636,790,732,161,024.0`  (bits `0x0e064891`) |
| **chainwork** | `11,869,711,951,511,378,186,657,714,697,493,163,902,110,643,667` expected hashes |
| **supply** | `20728.90625000 ROFL` in `1332` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `189` | `14.2%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `610.15625000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1332. Verify it yourself: <code>python3 verify.py</code></sub>
