...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1902"><img src="assets/ledger-light.svg?v=1902" width="100%" alt="ROFL ledger, height 1902"></picture>

| | |
|---|---|
| **height** | `1902` |
| **tip** | `77b7644e017b7d664eabfaa60bde84d6223facf60db4d84440c7dca6c6b78527` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,610,809,417,214` expected hashes |
| **supply** | `20960.25390625 ROFL` in `1903` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `464` | `24.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `705.08812500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1902. Verify it yourself: <code>python3 verify.py</code></sub>
