...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3817"><img src="assets/ledger-light.svg?v=3817" width="100%" alt="ROFL ledger, height 3817"></picture>

| | |
|---|---|
| **height** | `3817` |
| **tip** | `6774b3c091779b50961c40c13c216fb1da525a2efb7a936b34d2cea821123cde` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,889,719,674` expected hashes |
| **supply** | `20999.92712854 ROFL` in `3818` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1702` | `44.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.98580807 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3817. Verify it yourself: <code>python3 verify.py</code></sub>
