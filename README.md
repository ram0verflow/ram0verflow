...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2058"><img src="assets/ledger-light.svg?v=2058" width="100%" alt="ROFL ledger, height 2058"></picture>

| | |
|---|---|
| **height** | `2058` |
| **tip** | `3e2bfbea2525da6aad00e6e687c08e5ec2a46c6a25c25fbf41c443677025f1d2` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,101,545,646,886` expected hashes |
| **supply** | `20975.48828125 ROFL` in `2059` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `589` | `28.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `717.29515625 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2058. Verify it yourself: <code>python3 verify.py</code></sub>
