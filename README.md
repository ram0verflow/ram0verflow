...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1985"><img src="assets/ledger-light.svg?v=1985" width="100%" alt="ROFL ledger, height 1985"></picture>

| | |
|---|---|
| **height** | `1985` |
| **tip** | `98b1d279f87f3341d0f88a9aeb73097200314b054479c7bc59c03672cacec31f` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,871,906,257,360` expected hashes |
| **supply** | `20968.35937500 ROFL` in `1986` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `535` | `26.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `712.02171875 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1985. Verify it yourself: <code>python3 verify.py</code></sub>
