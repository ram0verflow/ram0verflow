...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1957"><img src="assets/ledger-light.svg?v=1957" width="100%" alt="ROFL ledger, height 1957"></picture>

| | |
|---|---|
| **height** | `1957` |
| **tip** | `659970c9d857299798601946f67d5e4f945e7f7d8188126fa22ac8a6256fcc55` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,783,825,395,624` expected hashes |
| **supply** | `20965.62500000 ROFL` in `1958` unspent outputs |
...
| `1948` | `377c10bde487b501fa4e…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.09765625` | 2026-09-12 12:15 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `515` | `26.3%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `24.9%` |
| [@americanvain](https://github.com/americanvain) | `315` | `16.1%` |
| [@sd5884703](https://github.com/sd5884703) | `142` | `7.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `710.06859375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1957. Verify it yourself: <code>python3 verify.py</code></sub>
