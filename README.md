...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1679"><img src="assets/ledger-light.svg?v=1679" width="100%" alt="ROFL ledger, height 1679"></picture>

| | |
|---|---|
| **height** | `1679` |
| **tip** | `94d9d3e1f734be709864189576b0d76faa4c37f0af6a5c97e299ce6462a387ca` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,909,308,268,388` expected hashes |
| **supply** | `20917.96875000 ROFL` in `1679` unspent outputs |
...
| `1670` | `941caab954ca5be03e79…` | [@ywltby](https://github.com/ywltby) | `飞八分钱干飞马` | `1` | `0.39062500` | 2026-09-11 12:17 UTC |
...
| [@americanvain](https://github.com/americanvain) | `244` | `14.5%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `160.54687500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1679. Verify it yourself: <code>python3 verify.py</code></sub>
