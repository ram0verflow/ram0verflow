...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3816"><img src="assets/ledger-light.svg?v=3816" width="100%" alt="ROFL ledger, height 3816"></picture>

| | |
|---|---|
| **height** | `3816` |
| **tip** | `30777d4a0c287469f1be635e42f388e4b3e0e8b653234f4f99ba727e33268ada` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,888,671,099` expected hashes |
| **supply** | `20999.92693781 ROFL` in `3817` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1701` | `44.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.98561734 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3816. Verify it yourself: <code>python3 verify.py</code></sub>
