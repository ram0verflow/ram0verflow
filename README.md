...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1351"><img src="assets/ledger-light.svg?v=1351" width="100%" alt="ROFL ledger, height 1351"></picture>

| | |
|---|---|
| **height** | `1351` |
| **tip** | `24d683261f366be0a4a0db86937f7c6275933837a22fb4ffbc07ebdb883670b0` |
| **difficulty** | `2,626,552,641,014,147,947,670,451,393,327,496,429,568.0`  (bits `0x0e0212a8`) |
| **chainwork** | `43,897,146,607,942,961,665,264,619,116,622,992,979,650,948,360` expected hashes |
| **supply** | `20743.75000000 ROFL` in `1351` unspent outputs |
...
| `1342` | `e18dd123306b8ea7e1d6…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.78125000` | 2026-09-10 17:53 UTC |
...
| [@americanvain](https://github.com/americanvain) | `53` | `3.9%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `52.34375000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1351. Verify it yourself: <code>python3 verify.py</code></sub>
