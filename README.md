...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2095"><img src="assets/ledger-light.svg?v=2095" width="100%" alt="ROFL ledger, height 2095"></picture>

| | |
|---|---|
| **height** | `2095` |
| **tip** | `4258a4efe7ce2bca99143af2afdb3818dc8bf975984ff8727a4db825a1cb96f4` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,217,938,214,180` expected hashes |
| **supply** | `20979.10156250 ROFL` in `2096` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2095. Verify it yourself: <code>python3 verify.py</code></sub>
