...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1892"><img src="assets/ledger-light.svg?v=1892" width="100%" alt="ROFL ledger, height 1892"></picture>

| | |
|---|---|
| **height** | `1892` |
| **tip** | `58b439d2c2689989249a12dc0805d0931c9b7448b4310d90fc1ee4e62136227c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,579,351,966,594` expected hashes |
| **supply** | `20959.27734375 ROFL` in `1893` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `454` | `24.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `704.11156250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1892. Verify it yourself: <code>python3 verify.py</code></sub>
