...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1966"><img src="assets/ledger-light.svg?v=1966" width="100%" alt="ROFL ledger, height 1966"></picture>

| | |
|---|---|
| **height** | `1966` |
| **tip** | `b6bdf1f6a4881602b6f3614194eba012b938333c582235b3fe61ab0635eb7292` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,812,137,101,182` expected hashes |
| **supply** | `20966.50390625 ROFL` in `1967` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1966` | `b6bdf1f6a4881602b6f3…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.09765625` | 2026-09-12 14:01 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `523` | `26.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `710.84984375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1966. Verify it yourself: <code>python3 verify.py</code></sub>
