...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1911"><img src="assets/ledger-light.svg?v=1911" width="100%" alt="ROFL ledger, height 1911"></picture>

| | |
|---|---|
| **height** | `1911` |
| **tip** | `98d0ad4cf9a1ed56c206a27cc9fc8aae48fac578a626ece05b1d0616d0552b2c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,639,121,122,772` expected hashes |
| **supply** | `20961.13281250 ROFL` in `1912` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1911` | `98d0ad4cf9a1ed56c206…` | [@ywltby](https://github.com/ywltby) | `干的飞马笑哈哈` | `1` | `0.09765625` | 2026-09-12 08:29 UTC |
...
| [@ywltby](https://github.com/ywltby) | `473` | `24.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `705.96703125 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1911. Verify it yourself: <code>python3 verify.py</code></sub>
