...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1936"><img src="assets/ledger-light.svg?v=1936" width="100%" alt="ROFL ledger, height 1936"></picture>

| | |
|---|---|
| **height** | `1936` |
| **tip** | `ce55a69838e9463d1cc085e51a803b7e3989983ee41f5f72f3e5c876c452ad6d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,717,764,749,322` expected hashes |
| **supply** | `20963.57421875 ROFL` in `1937` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `495` | `25.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `708.11546875 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1936. Verify it yourself: <code>python3 verify.py</code></sub>
