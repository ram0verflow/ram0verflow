...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1988"><img src="assets/ledger-light.svg?v=1988" width="100%" alt="ROFL ledger, height 1988"></picture>

| | |
|---|---|
| **height** | `1988` |
| **tip** | `1340cae37c8851f97a2efa96652a2390368a9735611c7795247f85524c2bce9b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,881,343,492,546` expected hashes |
| **supply** | `20968.65234375 ROFL` in `1989` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `538` | `27.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `712.31468750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1988. Verify it yourself: <code>python3 verify.py</code></sub>
