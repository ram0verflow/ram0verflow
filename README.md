...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2112"><img src="assets/ledger-light.svg?v=2112" width="100%" alt="ROFL ledger, height 2112"></picture>

| | |
|---|---|
| **height** | `2112` |
| **tip** | `936a6e0f736bb9e96a3b5542b2342a86407c36cccdd317bfb0eeecba5caf9636` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,271,415,880,234` expected hashes |
| **supply** | `20980.12695306 ROFL` in `2113` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2112` | `936a6e0f736bb9e96a3b…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 06:19 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `639` | `30.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `721.64085932 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2112. Verify it yourself: <code>python3 verify.py</code></sub>
