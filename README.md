...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1866"><img src="assets/ledger-light.svg?v=1866" width="100%" alt="ROFL ledger, height 1866"></picture>

| | |
|---|---|
| **height** | `1866` |
| **tip** | `92ef2af96ec874add65b2c56ff0f469b7cc64ec8024cfe7855eed986fac63bdf` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,497,562,594,982` expected hashes |
| **supply** | `20954.49218750 ROFL` in `1867` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1866` | `92ef2af96ec874add65b…` | [@ywltby](https://github.com/ywltby) | `谁是大明星？` | `1` | `0.19531250` | 2026-09-12 04:06 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `26.1%` |
| [@ywltby](https://github.com/ywltby) | `431` | `23.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `699.81468750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1866. Verify it yourself: <code>python3 verify.py</code></sub>
