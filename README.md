...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1826"><img src="assets/ledger-light.svg?v=1826" width="100%" alt="ROFL ledger, height 1826"></picture>

| | |
|---|---|
| **height** | `1826` |
| **tip** | `9cd1da430e1f5836e1b58f89b486e6b43033ca3823e19d80898565fd30dd47a2` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,371,732,792,502` expected hashes |
| **supply** | `20946.67968750 ROFL` in `1827` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `299` | `16.4%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `171.29006250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1826. Verify it yourself: <code>python3 verify.py</code></sub>
