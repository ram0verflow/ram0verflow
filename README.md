...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1867"><img src="assets/ledger-light.svg?v=1867" width="100%" alt="ROFL ledger, height 1867"></picture>

| | |
|---|---|
| **height** | `1867` |
| **tip** | `9b436bedd27a74f2c4a10e65cd01eb8028bfee518ab851d0228482d971b0acd3` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,500,708,340,044` expected hashes |
| **supply** | `20954.68750000 ROFL` in `1868` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1867` | `9b436bedd27a74f2c4a1…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.19531250` | 2026-09-12 04:11 UTC |
...
| [@ywltby](https://github.com/ywltby) | `432` | `23.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `700.01000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1867. Verify it yourself: <code>python3 verify.py</code></sub>
