...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1928"><img src="assets/ledger-light.svg?v=1928" width="100%" alt="ROFL ledger, height 1928"></picture>

| | |
|---|---|
| **height** | `1928` |
| **tip** | `8ffcd4c5e22fb994c18b1cdd354716710dfb61c64ad29d592d3208a91ed8920f` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,692,598,788,826` expected hashes |
| **supply** | `20962.79296875 ROFL` in `1929` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `489` | `25.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `707.52953125 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1928. Verify it yourself: <code>python3 verify.py</code></sub>
