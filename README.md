...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1865"><img src="assets/ledger-light.svg?v=1865" width="100%" alt="ROFL ledger, height 1865"></picture>

| | |
|---|---|
| **height** | `1865` |
| **tip** | `f3835ea6642bbc4b397cbbb5974b52fd7749df96a39eb9d55adec70ba8867123` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,494,416,849,920` expected hashes |
| **supply** | `20954.29687500 ROFL` in `1866` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1865` | `f3835ea6642bbc4b397c…` | [@ywltby](https://github.com/ywltby) | `飞八分钱干飞马` | `1` | `0.19531250` | 2026-09-12 04:00 UTC |
| `1864` | `ef4561a4b673a41de726…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.19531250` | 2026-09-12 03:53 UTC |
...
| [@ywltby](https://github.com/ywltby) | `430` | `23.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `699.61937500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1865. Verify it yourself: <code>python3 verify.py</code></sub>
