...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1335"><img src="assets/ledger-light.svg?v=1335" width="100%" alt="ROFL ledger, height 1335"></picture>

| | |
|---|---|
| **height** | `1335` |
| **tip** | `6e8cd24f55837e4c7c875f074bf06f9fc649b8ae2027b58377c0fa333dfabc01` |
| **difficulty** | `866,483,702,191,367,860,376,226,636,790,732,161,024.0`  (bits `0x0e064891`) |
| **chainwork** | `14,595,433,995,038,425,613,836,976,976,177,105,959,923,253,432` expected hashes |
| **supply** | `20731.25000000 ROFL` in `1335` unspent outputs |
...
| `1326` | `0cc247d4861066099cde…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 16:56 UTC |
...
| [@ywltby](https://github.com/ywltby) | `192` | `14.4%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `612.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1335. Verify it yourself: <code>python3 verify.py</code></sub>
