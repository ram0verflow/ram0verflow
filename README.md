...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1426"><img src="assets/ledger-light.svg?v=1426" width="100%" alt="ROFL ledger, height 1426"></picture>

| | |
|---|---|
| **height** | `1426` |
| **tip** | `bf63361e4483d15d854a2dd7a2e4231cd1ad623678bf9a7d7c0f92062e8d4c46` |
| **difficulty** | `1,425,376,885,543,683,781,568,524,632,380,112,076,013,568.0`  (bits `0x0d00fa54`) |
| **chainwork** | `13,797,181,547,099,399,174,955,638,724,402,032,440,569,593,572,822` expected hashes |
| **supply** | `20802.34375000 ROFL` in `1426` unspent outputs |
...
| `1417` | `cd00985a3812a45b8b97…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.78125000` | 2026-09-10 21:44 UTC |
...
| [@americanvain](https://github.com/americanvain) | `113` | `7.9%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `99.21875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1426. Verify it yourself: <code>python3 verify.py</code></sub>
