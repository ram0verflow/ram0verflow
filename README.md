...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1812"><img src="assets/ledger-light.svg?v=1812" width="100%" alt="ROFL ledger, height 1812"></picture>

| | |
|---|---|
| **height** | `1812` |
| **tip** | `ced5c5b559201c07ec626b7136e7781959ce6d414f8b38cfb6efcca0f8e6b7c8` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,327,692,361,634` expected hashes |
| **supply** | `20943.94531250 ROFL` in `1813` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `399` | `22.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `693.56468750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1812. Verify it yourself: <code>python3 verify.py</code></sub>
