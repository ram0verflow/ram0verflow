...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1488"><img src="assets/ledger-light.svg?v=1488" width="100%" alt="ROFL ledger, height 1488"></picture>

| | |
|---|---|
| **height** | `1488` |
| **tip** | `0041f47b896573c8551afc8f010ba27d506013404f8b3a8b030d3b8060e9ff22` |
| **difficulty** | `198,157,958,403,267,995,143,695,871,938,053,484,960,546,816.0`  (bits `0x0c01ccf7`) |
| **chainwork** | `1,576,914,700,716,644,132,167,846,793,567,928,974,905,180,904,603,289` expected hashes |
| **supply** | `20843.35937500 ROFL` in `1488` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `144` | `9.7%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `121.48437500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1488. Verify it yourself: <code>python3 verify.py</code></sub>
