...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1922"><img src="assets/ledger-light.svg?v=1922" width="100%" alt="ROFL ledger, height 1922"></picture>

| | |
|---|---|
| **height** | `1922` |
| **tip** | `9aa2f2c3b3c048844d0d12a9194cb4615086f7878ad54216a7a64a585c08025c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,673,724,318,454` expected hashes |
| **supply** | `20962.20703125 ROFL` in `1923` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `483` | `25.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `706.94359375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1922. Verify it yourself: <code>python3 verify.py</code></sub>
