...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1658"><img src="assets/ledger-light.svg?v=1658" width="100%" alt="ROFL ledger, height 1658"></picture>

| | |
|---|---|
| **height** | `1658` |
| **tip** | `bdce546a32f068cef89f312f9afdcbeb7e427b82a662920e07b7fe2722529faa` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,843,247,622,086` expected hashes |
| **supply** | `20909.76562500 ROFL` in `1658` unspent outputs |
...
| `1649` | `929614a41a37e01ae907…` | [@ywltby](https://github.com/ywltby) | `奈斯~~` | `1` | `0.39062500` | 2026-09-11 10:58 UTC |
...
| [@americanvain](https://github.com/americanvain) | `234` | `14.1%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `156.64062500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1658. Verify it yourself: <code>python3 verify.py</code></sub>
