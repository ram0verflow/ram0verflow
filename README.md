...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1357"><img src="assets/ledger-light.svg?v=1357" width="100%" alt="ROFL ledger, height 1357"></picture>

| | |
|---|---|
| **height** | `1357` |
| **tip** | `12100eec9eeae7e9e3f0ba7c8612142311722b25c3cdf5b0121e0f9142843576` |
| **difficulty** | `2,626,552,641,014,147,947,670,451,393,327,496,429,568.0`  (bits `0x0e0212a8`) |
| **chainwork** | `60,421,986,980,567,268,849,476,826,164,589,524,128,821,500,026` expected hashes |
| **supply** | `20748.43750000 ROFL` in `1357` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `58` | `4.3%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `56.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1357. Verify it yourself: <code>python3 verify.py</code></sub>
