...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2066"><img src="assets/ledger-light.svg?v=2066" width="100%" alt="ROFL ledger, height 2066"></picture>

| | |
|---|---|
| **height** | `2066` |
| **tip** | `6ea1c34470da5b865eb15e272daeca0cc44c69779b9fa11a0f1dd6240aad31a7` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,126,711,607,382` expected hashes |
| **supply** | `20976.26953125 ROFL` in `2067` unspent outputs |
...
| `2057` | `e4dc0cd2a82cb20ebd51…` | [@iamgd67](https://github.com/iamgd67) | `gm` | `1` | `0.09765625` | 2026-09-12 23:43 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `597` | `28.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `718.07640625 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2066. Verify it yourself: <code>python3 verify.py</code></sub>
