...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1863"><img src="assets/ledger-light.svg?v=1863" width="100%" alt="ROFL ledger, height 1863"></picture>

| | |
|---|---|
| **height** | `1863` |
| **tip** | `823362677bb197239061e04ddaa097d9e858c9697c8d4317133bc76885cc2870` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,488,125,359,796` expected hashes |
| **supply** | `20953.90625000 ROFL` in `1864` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1863` | `823362677bb197239061…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.19531250` | 2026-09-12 03:47 UTC |
...
| [@ywltby](https://github.com/ywltby) | `428` | `23.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `699.22875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1863. Verify it yourself: <code>python3 verify.py</code></sub>
