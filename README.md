...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1823"><img src="assets/ledger-light.svg?v=1823" width="100%" alt="ROFL ledger, height 1823"></picture>

| | |
|---|---|
| **height** | `1823` |
| **tip** | `90d27015115342893346be87618fcfbe684f0be707e24c1ca4cb4b26085a6239` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,362,295,557,316` expected hashes |
| **supply** | `20946.09375000 ROFL` in `1824` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `407` | `22.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `695.12718750 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1823. Verify it yourself: <code>python3 verify.py</code></sub>
