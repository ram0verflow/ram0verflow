...
|---|---|
| **height** | `1522` |
| **tip** | `29c0cefadce293ca904b48382b01ae7901c6056aa6f189926d2580444622f401` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,415,426,293,654` expected hashes |
...
|--:|---|---|---|--:|--:|---|
| `1522` | `29c0cefadce293ca904b…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.39062500` | 2026-09-11 03:13 UTC |
...
| [@americanvain](https://github.com/americanvain) | `170` | `11.2%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `131.64062500 ROFL` |
