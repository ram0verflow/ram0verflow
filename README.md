...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1784"><img src="assets/ledger-light.svg?v=1784" width="100%" alt="ROFL ledger, height 1784"></picture>

| | |
|---|---|
| **height** | `1784` |
| **tip** | `3f577804d40d78c09aced21aff87b69ea1e6a913284f9352f4465ead41ca49ca` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,365,239,611,499,898` expected hashes |
| **supply** | `20938.47656250 ROFL` in `1785` unspent outputs |
...
| `1778` | `f608159988ee9f194b57…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.19531250` | 2026-09-11 20:31 UTC |
| `1777` | `0b13ace88b5d8b6be303…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.19531250` | 2026-09-11 20:26 UTC |
| `1776` | `6431c9f573c53d9c862e…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-11 20:26 UTC |
| `1775` | `f15c81d19a3c2a1ee687…` | [@americanvain](https://github.com/americanvain) | `testing` | `1` | `0.19531250` | 2026-09-11 20:21 UTC |
...
| [@ywltby](https://github.com/ywltby) | `382` | `21.4%` |
| [@americanvain](https://github.com/americanvain) | `283` | `15.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `690.24437500 ROFL` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `168.16506250 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1784. Verify it yourself: <code>python3 verify.py</code></sub>
